...
class commandAddTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$command = new \ProfiCloS\VestaCP\Command\Add\WebDomain('admin', 'domain.com');
	...
	{
		$command = new \ProfiCloS\VestaCP\Command\Add\WebDomainFtp('admin', 'domain.com', 'account', 'pass');
	...
	{
		$command = new \ProfiCloS\VestaCP\Command\Add\LetsEncryptDomain('admin', 'domain.com');
	...
	{
		$command = new \ProfiCloS\VestaCP\Command\Add\MailAccount('admin', 'domain.com', 'account', 'pass');
	...
	{
		$command = new \ProfiCloS\VestaCP\Command\Add\MailDomain('admin', 'domain.com');
